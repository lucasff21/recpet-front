...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light nav-principal" style={{ backgroundColor: '#FFF' }}>
        ...
        <div className="collapse navbar-collapse nav-area-cliente2">
          <div className="navbar-nav">
            <button type="button" className="button-customer1" onClick={() => window.location.href = "/area-cliente"}>
