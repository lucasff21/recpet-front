            ...
            <div className="container footer-items">
                <div className="row align-items-center justify-content-evenly">
                    <div className="col-4 details">
                        ...
                        <p>Desenvolvido por: Lucas França Freita</p>
                    </div>
                    ...
                    <address className ="col-4">
                        <ul className="list-group no-bullets">
                            <li className="list-group-contact">
                                <div className="icon-container">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF9500"
                                ...
                                <a href="https://wa.me/5571999999999">(71) 9 9999-9999</a>
                            </li>
                            ...
                            <li className="list-group-contact">
                                ...
                                <a href="mailto:ceapg-ic@ufba.br">ceapg-ic@ufba.br</a>
                            </li>
                        </ul>
                    </address>
                </div>
