...
const FilterSidebar = ({
  ...
  const CheckboxList = ({
    ...
    >
      {items.map((item) => (
        <div key={item[idKey]} className="flex items-center">
          <input
            type="checkbox"
      ...
      >
        ...
        <div className="mt-8 space-y-3">
          <button
            ...
            className="w-full bg-blue-600 text-white py-2.5 rounded-md font-semibold hover:bg-blue-700 transition shadow-md"
          >
            Aplicar Filtros
          </button>
          <button
