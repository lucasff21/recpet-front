...
const Header = () => {
    ...
    return (
        <header className="flex justify-between items-center px-4 py-2 bg-white shadow-md relative">
            ...
            <nav
                className={`absolute gap-4 md:static top-16 left-0 w-full md:w-auto bg-white shadow-md md:shadow-none flex flex-col md:flex-row md:space-x-8 p-2 md:p-0 ${menuOpen ? 'block' : 'hidden'} md:flex`}>
            ...
            {user ? (
                <div className="hidden md:flex items-center gap-2 cursor-pointer hover:bg-amber-700 hover:text-white px-2 py-1 rounded">
